...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 16, 2024 at 01:58 PM
...
(23, 'Kimetsu no yaiba', 'Koyoharu Gotouge', 'Shueisha', 'Manga', 'upload/books/kimetsu.png', 0, 550.00, 4, 18),
...
(26, 'Yazakura Family', 'Hitsuji Gondaira', 'Shueisha', 'Manga', 'upload/books/yozakura.png', 0, 350.00, 0, 10),
(27, 'Shied Hero', 'Aneko Yusagi', 'Media Factory', 'Manga', 'upload/books/tatenoyush.png', 1, 350.00, 0, 10),
(28, '5 toubun no hanayome', 'Negi Haruba', 'Kodansha', 'Manga', 'upload/books/gotoubun.png', 1, 450.00, 2, 8),
(29, 'Is It Wrong to Try to Pick Up Girls in a Dungeon?', 'Fujino Omori', 'SB Creative', 'Manga', 'upload/books/danmachi.png', 1, 500.00, 10, 3),
...
(32, 'When the Dragon King Falls for the Loli Alchemist', '', '', 'Webcomics', 'upload/books/image_2024-07-14_003543487.png', 0, 550.00, 2, 9),
...
(38, 'Spider Man', 'Stan lee', 'Marvel Comics', 'Comics', 'upload/books/spider.png', 0, 500.00, 2, 11),
...
INSERT INTO `borrow` (`id`, `book_id`, `customer_name`, `borrow_date`, `due_date`, `penalty_paid`, `returned`) VALUES
(40, 23, '1', '2024-07-16', '2024-07-19', 0, 1),
(42, 38, '1', '2024-07-16', '2024-07-19', 0, 1);
...
(114, 13, '28', '2024-07-13 17:25:24', 1, 450.00),
(115, 13, '28', '2024-07-13 17:26:00', 1, 450.00);
...
(435369, 114, 13, '2024-07-13 17:25:24', 450.00, 'debit_card'),
(435370, 115, 13, '2024-07-13 17:26:00', 450.00, 'credit_card');
...
(13, 'Among', 'Us', 'RaiRai', '$2y$10$wtspj3tNFPbdCrP1DfXzL.yb.RYjIDo0oob./K4028H4VvVoJ0VVW', 'sitchonjames071@gmail.com', '', '', 0, 0, 0, 'upload/currentuser/Among Us.jpg', '1', '15104'),
(14, 'Lance', 'Musngi', 'lance', '$2y$10$XqpeRMY/YBq9vR2Ip5JM9OVYIkvxtcTRH6uwNJ3m32/j8azV35L0m', 'lance.musngi@gmail.com', '', '', 0, 0, 0, 'upload/currentuser/new.png', '', '');
...
--
ALTER TABLE `payment`
  MODIFY `payment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=435371;
